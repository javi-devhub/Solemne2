...
| Día               | Actividad planificada                                                                                                                     | Estado |
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------- | ------ |
| Lunes 18 de mayo  | Implementar y testear eventos de tensión, como screamer, glitch visual o aparición de la presencia, además de consecuencias por errores.            | X      |
